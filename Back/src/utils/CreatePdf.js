...
function generateHeader(doc) {
  doc
    ...
    .fillColor("#444444")
    .fontSize(20)
    .text("FreshCart", 110, 57)
    .fontSize(10)
    .text("FreshCart", 200, 50, { align: "right" })
...
function generateCustomerInformation(doc, invoice) {
  ...
  doc
    ...
    .font("Helvetica")
    .text(invoice.shipping.address.phone, 300, customerInformationTop + 15)
    .text(
        invoice.shipping.address.street +
        ", " +
        invoice.shipping.address.city +
        ", " +
