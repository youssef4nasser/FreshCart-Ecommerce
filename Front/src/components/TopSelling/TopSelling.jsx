...
import { productsData } from "../../../FakeData/topSelling.js";
   ...
   <section className="bg-body-tertiary py-5">
    <Container>
      ...
      {productsData.map((item, index)=>{
          return(
            <Col key={index} md={6} className="border border-hover position-relative bg-white">
            <Stack direction="horizontal" className="py-3 cursor-pointer product-item justify-content-around">
              <div>
                ...
                <div className="position-absolute top-0 end-0 my-3 d-flex flex-column btn-add cursor-pointer">
                  ...
                  {/* <FontAwesomeIcon icon={faEye} style={{color: "#ddd"}} size='lg' /> */}
                  <MdalShow data={item} />
                </div>
              </div>
              <div>
